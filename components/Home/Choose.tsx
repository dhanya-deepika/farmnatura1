        ...
        <div className="flex flex-col lg:flex-row items-start justify-between gap-0">
          ...
          <div className="w-auto">
            <h2
              ...
              leading-tight"
            >
              Reason to  <span>Choose<br/>Us!</span>
            </h2>
          </div>

          {/* Right Column - Farmland Image + Text */}
          <div className="flex flex-col sm:flex-row items-center justify-center w-full text-center sm:text-left gap-0">
            <Image
            ...
            />
            <div className="mt-3 sm:mt-0 sm:ml-0 md:ml-0">
